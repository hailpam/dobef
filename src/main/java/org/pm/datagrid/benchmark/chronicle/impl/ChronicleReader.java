package org.pm.datagrid.benchmark.chronicle.impl;
 ...
 * @author pmaresca
 */
public class ChronicleReader implements Runnable {
    ...
    public ChronicleReader(int nrReads, int dataSize, String mapName,
